...
2. Then, execute `multi_eval.sh` in the `evaluation` folder to perform GPT evaluation.
...
1. Run `multi_session_eval.sh` inside the `update_task` folder.
2. Then, execute `episode_share.sh` in the `evaluation` folder to perform GPT evaluation.
