...
def main():
    ...
    # Average score
    print(f"Avg Consistency Score: {total_consistency_score}")
    print(f"Avg Reflectiveness Score: {total_reflectiveness_score}")
    print(f"Avg Engagingness Score: {total_engagingness_score}")    
